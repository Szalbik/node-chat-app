...
(function defineMustache(global, factory) {
  ...
  function parseTemplate(template, tags) {
    ...
    let openingTagRe; var closingTagRe; var closingCurlyRe;
    ...
    let start; var type; var value; var chr; var token; var openSection;
    while (!scanner.eos()) {
      start = scanner.pos;
  ...
  Scanner.prototype.scanUntil = function scanUntil(re) {
    let index = this.tail.search(re); var
      match;
  ...
  Context.prototype.lookup = function lookup(name) {
    ...
    if (cache.hasOwnProperty(name)) {
      ...
      let context = this; var intermediateValue; var names; var index; var lookupHit = false;
  ...
  Writer.prototype.renderTokens = function renderTokens(
    ...
    let token; var symbol; var value;
    for (let i = 0, numTokens = tokens.length; i < numTokens; ++i) {
      value = undefined;
      token = tokens[i];
      symbol = token[0];
